...
public interface UsuarioRepository extends JpaRepository<Usuario, Long>, JpaSpecificationExecutor<Usuario> {
    ...
    @Query("SELECT u FROM Usuario u WHERE u.rol = com.flashpage.app.usuario.model.Rol.ASESOR AND u.activo = true")
    ...
    @Query(value = """
        ...
        """,
        countQuery = "SELECT COUNT(*) FROM usuario u WHERE u.rol = 'ASESOR' AND u.activo = true",
        nativeQuery = true)
