...
import com.flashpage.app.service.VentaService;
...
public class VentaController {
    ...
    public PageResponse<VentaResponse> obtener(
        ...
        if (supervisorId != null)
            spec = spec.and(VentaSpecification.supervisorId(supervisorId));
        if (jefeDeSupervisorId != null)
            spec = spec.and(VentaSpecification.jefeDeSupervisorId(jefeDeSupervisorId));
        if (origen != null)
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public VentaDetalleResponse obtenerDetalle(
