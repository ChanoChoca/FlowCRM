package com.flashpage.app.ticket.controller;
...
import com.flashpage.app.ticket.service.TicketService;
...
public class TicketController {
    ...
    @PostMapping
    public ResponseEntity<TicketResponse> crear(@RequestBody CreateTicketRequest req, @AuthenticationPrincipal Usuario usuario) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TicketResponse> obtener(@PathVariable Long id, @AuthenticationPrincipal Usuario usuario) {
        return ResponseEntity.ok(service.obtener(id, usuario));
    }

    @PatchMapping("/{id}/estado")
    public ResponseEntity<TicketResponse> cambiarEstado(@PathVariable Long id, @RequestParam EstadoTicket estado, @AuthenticationPrincipal Usuario usuario) {
        return ResponseEntity.ok(service.cambiarEstado(id, estado, usuario));
    }

    @PostMapping("/{id}/mensajes")
    public ResponseEntity<TicketResponse> responder(@PathVariable Long id, @RequestBody TicketMensajeRequest req, @AuthenticationPrincipal Usuario usuario) {
