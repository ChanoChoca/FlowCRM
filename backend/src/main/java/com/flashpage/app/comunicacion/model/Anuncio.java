package com.flashpage.app.comunicacion.model;
...
public class Anuncio {
    ...
    public List<Rol> getRolesDestino() { return rolesDestino; }
    public void setRolesDestino(List<Rol> rolesDestino) { this.rolesDestino = rolesDestino; }
    public List<Long> getLeidoPor() { return leidoPor; }
    public void setLeidoPor(List<Long> leidoPor) { this.leidoPor = leidoPor; }
