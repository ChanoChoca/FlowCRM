...
import com.flashpage.app.service.DashboardService;
...
public class DashboardController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('ASESOR','SUPERVISOR','JEFE_DE_SUPERVISOR'," +
            "'GERENTE','LIDER','ADMINISTRACION_RRHH_COBRANZA')")
    ...
    public ResponseEntity<RankingOpcional> toggleRanking(
            @AuthenticationPrincipal Usuario usuario) {
    ...
    public PageResponse<ActividadUsuario> getActividadUsuarios(
        ...
        return PageResponse.from(
                dashboardService.getActividadUsuarios(usuario, page, size, sortBy, sortDir));
    }
}