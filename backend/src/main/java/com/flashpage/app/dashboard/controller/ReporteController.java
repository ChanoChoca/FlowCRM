...
import com.flashpage.app.dashboard.service.ReporteService;
...
public class ReporteController {
    ...
    public ResponseEntity<byte[]> exportarVentas(
        ...
        byte[] bytes = reporteService.generarReporteVentas(cliente, producto, central, asesorId, origen, estado, desde, hasta);
