...
public final class DashboardDTOs {
        ...
        public record HeatmapDia(
                        LocalDate fecha,
                        long cantidad,
                        int nivel) {
        }

        public record RankingOpcional(
                        boolean activo,
                        Integer posicion,
                        Integer totalAsesores,
                        Double promedioEquipo,
                        long propiasMesActual) {
        }
        ...
        public record AsesorResumen(
                        ...
                        String apellido,
                        long ventasMes,
                        double proporcionEnEquipo,
                        boolean conVentasHoy,
                        boolean enRacha) {
        }

        public record SupervisorResumen(
                        Long usuarioId,
                        String nombre,
                        String apellido,
                        long ventasMes,
                        long ventasHoy,
                        long totalAsesores,
                        double proporcionEnJefe,
                        boolean equipoEnRiesgo,
                        Double tendenciaPctMes) {
        }

        public record StatsDebito(
                        long totalVentas,
                        long conDebitoAuto,
                        double porcentajeDebito) {
        }

        public record AccionRapida(
                        String codigo,
                        String label,
                        String icono,
                        String ruta) {
        ...
        public record StatsUsuarios(
                        long activos,
                        long inactivos,
                        long altasMes,
                        long bajasMes,
                        long incompletos,
                        long sinLoginUltimos30Dias) {
        }

        public record OrigenTendenciaDia(
                        LocalDate fecha,
                        long ventasCrm,
                        long ventasPowerApp) {
        }
        ...
        public record CompSemana(
                ...
                public static CompSemana calcular(long actual, long mejorPrevio) {
                        ...
                        if (mejorPrevio == 0) {
                                ...
                                mensaje = "Tu mejor semana fue " + mejorPrevio
        ...
        /**
         * Comparativa mensual: mes actual vs mes anterior, vs mismo mes año pasado,
         * posición en el equipo y proyección de cierre de mes.
         */
        public record ComparativaAsesor(
                        // Mes actual
                        long ventasMesActual,
                        int metaMesActual,
                        double porcentajeMeta,

                        // vs mes anterior
                        long ventasMesAnterior,
                        Double tendenciaMesAnterior,

                        // vs mismo mes año pasado
                        long ventasMismoMesAnioAnterior,
                        Double tendenciaAnual,

                        // Posición en equipo (null si no tiene supervisor)
                        Integer posicionEquipo,
                        Integer totalEquipo,
                        double promedioEquipo,

                        // Forecast lineal de cierre de mes
                        long forecastCierreMes,
                        double forecastPorcentajeMeta,
                        int diasRestantesMes,
                        double promedioVentasDiarias,
